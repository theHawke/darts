...
var $author$project$Main$GameSelect = F2(
	function (a, b) {
		return {$: 'GameSelect', a: a, b: b};
	});
var $author$project$Main$initState = A2($author$project$Main$GameSelect, 'Tactics', '');
...
var $author$project$Main$HalbierenState = function (a) {
	return {$: 'HalbierenState', a: a};
};
			...
			while (true) {
				if (!ll.b) {
					return _Utils_Tuple2(
						$elm$core$List$reverse(la),
						$elm$core$List$reverse(lb));
				} else {
					if (!ll.b.b) {
						var a = ll.a;
						var $temp$ll = _List_Nil,
							$temp$la = A2($elm$core$List$cons, a, la),
							$temp$lb = lb;
						ll = $temp$ll;
						la = $temp$la;
						lb = $temp$lb;
						...
						var $temp$ll = lr,
							$temp$la = A2($elm$core$List$cons, a, la),
							$temp$lb = A2($elm$core$List$cons, b, lb);
						ll = $temp$ll;
						la = $temp$la;
						lb = $temp$lb;
						continue helper;
...
var $author$project$Tactics$makeInitState = function (players) {
	...
	var players_b = _v0.b;
	return {
		choice: $elm$core$Maybe$Nothing,
		currentDarts: 3,
		currentTeam: $author$project$Tactics$A,
		history: _List_Nil,
		scoreBoard: $elm$core$Dict$fromList(
			A2(
				$author$project$Util$zip,
				_List_fromArray(
					[20, 19, 18, 17, 16, 15, 14, 13, 12, 23, 22, 25]),
				A2(
					$elm$core$List$repeat,
					12,
					_Utils_Tuple2(3, 3)))),
		teamACurrent: 0,
		teamANames: $elm$core$Array$fromList(players_a),
		teamAPoints: 0,
		teamBCurrent: 0,
		teamBNames: $elm$core$Array$fromList(players_b),
		teamBPoints: 0
	};
};
...
var $author$project$Halbieren$dartboardValue = function (d) {
	switch (d.$) {
		case 'Bull':
			return 25;
		case 'DBull':
...
var $author$project$Halbieren$getPlayerPoints = F2(
	function (p, t) {
		return A2(
			$elm$core$Maybe$withDefault,
			-1,
...
var $author$project$Halbieren$isBull = function (d) {
	switch (d.$) {
		case 'Bull':
			return true;
		case 'DBull':
...
var $author$project$Halbieren$isDouble = function (d) {
	switch (d.$) {
		case 'D':
			var n = d.a;
			return true;
...
var $author$project$Halbieren$greens = _List_fromArray(
...
var $author$project$Halbieren$isGreen = function (d) {
	switch (d.$) {
		case 'Bull':
			return true;
		case 'D':
			var n = d.a;
			return A2($elm$core$List$member, n, $author$project$Halbieren$greens);
		case 'T':
			var n = d.a;
			return A2($elm$core$List$member, n, $author$project$Halbieren$greens);
		default:
...
var $author$project$Halbieren$isNumber = F2(
	function (n, dart) {
		switch (dart.$) {
			case 'G':
				var x = dart.a;
				return _Utils_eq(x, n);
			case 'K':
				var x = dart.a;
				return _Utils_eq(x, n);
			case 'D':
...
var $author$project$Halbieren$reds = _List_fromArray(
	[20, 18, 13, 10, 2, 3, 7, 8, 14, 12]);
var $author$project$Halbieren$isRed = function (d) {
	switch (d.$) {
		case 'DBull':
			return true;
		case 'D':
			var n = d.a;
			return A2($elm$core$List$member, n, $author$project$Halbieren$reds);
		case 'T':
			var n = d.a;
			return A2($elm$core$List$member, n, $author$project$Halbieren$reds);
		default:
...
var $author$project$Halbieren$isTriple = function (d) {
	if (d.$ === 'T') {
		var n = d.a;
		return true;
	} else {
...
var $author$project$Halbieren$isValidForRound = F2(
	function (round, dart) {
		switch (round.$) {
			case 'Number':
				var n = round.a;
				return A2($author$project$Halbieren$isNumber, n, dart);
			case 'Triple':
				return $author$project$Halbieren$isTriple(dart);
			case 'Double':
				return $author$project$Halbieren$isDouble(dart);
			case 'Green':
...
var $author$project$Halbieren$dartThrowUpdate = F2(
	function (d, s) {
		...
		var oldPlayerPoints = A2($author$project$Halbieren$getPlayerPoints, s.currentPlayer, s.playerPoints);
		var numPlayers = $elm$core$Array$length(s.playerNames);
		var nextPlayer = A2($elm$core$Basics$modBy, numPlayers, s.currentPlayer + 1);
		...
		var gameFinished = _Utils_eq(
			currentRound,
			$author$project$Halbieren$Number(-1));
		var newCurrentPoints = A2($author$project$Halbieren$isValidForRound, currentRound, d) ? (s.currentPoints + $author$project$Halbieren$dartboardValue(d)) : s.currentPoints;
		var newPlayerPoints = (!newCurrentPoints) ? (((oldPlayerPoints + 1) / 2) | 0) : (oldPlayerPoints + newCurrentPoints);
		var playerPointsUpdate = A3($author$project$Halbieren$addPlayerPoints, s.currentPlayer, s.playerPoints, newPlayerPoints);
		return gameFinished ? s : (turnFinished ? _Utils_update(
			s,
			{
				currentDarts: 3,
				currentPlayer: nextPlayer,
...
var $author$project$Halbieren$undoPlayerPoints = F2(
	function (p, t) {
		return A3(
			$elm$core$Dict$update,
			p,
...
var $author$project$Halbieren$undoUpdate = function (s) {
	var _v0 = s.history;
	if (!_v0.b) {
		return s;
	} else {
		...
		return (!turn) ? _Utils_update(
			...
			s,
			{
				...
				currentPoints: points,
				history: histRemainder,
				playerPoints: A2($author$project$Halbieren$undoPlayerPoints, player, s.playerPoints)
			});
	}
};
var $author$project$Halbieren$update = F2(
	function (msg, state) {
		switch (msg.$) {
			case 'UndoMsg':
				return $author$project$Halbieren$undoUpdate(state);
			case 'DartboardMsg':
				var dart = msg.a;
				return A2($author$project$Halbieren$dartThrowUpdate, dart, state);
			default:
				return state;
		}
	});
...
var $author$project$Tactics$victory = function (s) {
	var _v0 = $elm$core$List$unzip(
		$elm$core$Dict$values(s.scoreBoard));
	var cas = _v0.a;
	var cbs = _v0.b;
...
var $author$project$Tactics$scoreEntryUpdate = F2(
	function (_v0, s) {
		var value = _v0.value;
		var variant = _v0.variant;
		var useSpecial = _v0.useSpecial;
		var point_value = useSpecial ? (variant * value) : value;
		var count = useSpecial ? 1 : variant;
		var change_team = s.currentDarts === 1;
		var new_darts = change_team ? 3 : (s.currentDarts - 1);
		var new_team = change_team ? $author$project$Tactics$otherTeam(s.currentTeam) : s.currentTeam;
		var new_teamACurrent = (change_team && _Utils_eq(s.currentTeam, $author$project$Tactics$A)) ? A2(
			$elm$core$Basics$modBy,
			$elm$core$Array$length(s.teamANames),
			s.teamACurrent + 1) : s.teamACurrent;
		var new_teamBCurrent = (change_team && _Utils_eq(s.currentTeam, $author$project$Tactics$B)) ? A2(
			$elm$core$Basics$modBy,
			$elm$core$Array$length(s.teamBNames),
			s.teamBCurrent + 1) : s.teamBCurrent;
		var category = useSpecial ? (variant + 20) : value;
		var _v1 = function () {
			var _v2 = A2($elm$core$Dict$get, category, s.scoreBoard);
			if (_v2.$ === 'Nothing') {
				...
				var ca = _v3.a;
				var cb = _v3.b;
				var _v4 = s.currentTeam;
				if (_v4.$ === 'A') {
					return (_Utils_cmp(count, ca) > 0) ? _Utils_Tuple3(
						category,
						ca,
						(cb > 0) ? (point_value * (count - ca)) : 0) : _Utils_Tuple3(category, count, 0);
				} else {
					return (_Utils_cmp(count, cb) > 0) ? _Utils_Tuple3(
						category,
						cb,
						(ca > 0) ? (point_value * (count - cb)) : 0) : _Utils_Tuple3(category, count, 0);
				}
			}
		}();
		var category_actual = _v1.a;
		var count_actual = _v1.b;
		var points = _v1.c;
		var scoreUpdate = $elm$core$Maybe$andThen(
			function (_v5) {
				var ca = _v5.a;
				var cb = _v5.b;
				var _v6 = s.currentTeam;
				if (_v6.$ === 'A') {
					return ((!(ca - count_actual)) && (!cb)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
						_Utils_Tuple2(ca - count_actual, cb));
				} else {
					return ((!ca) && (!(cb - count_actual))) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
						_Utils_Tuple2(ca, cb - count_actual));
				}
			});
		var new_scoreBoard = (!category_actual) ? s.scoreBoard : A3($elm$core$Dict$update, category, scoreUpdate, s.scoreBoard);
		var historyEntry = {category: category_actual, count: count_actual, points: points};
		var new_teamAPoints = _Utils_eq(s.currentTeam, $author$project$Tactics$A) ? (s.teamAPoints + points) : s.teamAPoints;
		var new_teamBPoints = _Utils_eq(s.currentTeam, $author$project$Tactics$B) ? (s.teamBPoints + points) : s.teamBPoints;
		return _Utils_eq(
			$author$project$Tactics$victory(s),
			$author$project$Tactics$Undecided) ? _Utils_update(
			s,
			{
				choice: $elm$core$Maybe$Nothing,
...
var $author$project$Tactics$dartThrowUpdate = F2(
	function (d, s) {
		var _v0 = function () {
			switch (d.$) {
				case 'Bull':
					return _Utils_Tuple2(25, 1);
				case 'DBull':
					return _Utils_Tuple2(25, 2);
				case 'G':
					var n = d.a;
					return _Utils_Tuple2(n, 1);
				case 'K':
					var n = d.a;
					return _Utils_Tuple2(n, 1);
				case 'D':
					var n = d.a;
					return _Utils_Tuple2(n, 2);
				case 'T':
					var n = d.a;
					return _Utils_Tuple2(n, 3);
				default:
		...
		var value = _v0.a;
		var variant = _v0.b;
		var choice = A2($elm$core$Dict$member, value, s.scoreBoard) && A2($elm$core$Dict$member, variant + 20, s.scoreBoard);
		var useSpecial = A2($elm$core$Dict$member, variant + 20, s.scoreBoard);
		return choice ? _Utils_update(
			s,
			{
				choice: $elm$core$Maybe$Just(
					{value: value, variant: variant})
			}) : A2(
			$author$project$Tactics$scoreEntryUpdate,
			{useSpecial: useSpecial, value: value, variant: variant},
			s);
	});
var $author$project$Tactics$undoUpdate = function (s) {
	var _v0 = s.history;
	if (!_v0.b) {
		return s;
	} else {
		...
		var points = _v0.a.points;
		var hist_remainder = _v0.b;
		var change_team = s.currentDarts === 3;
		var new_darts = change_team ? 1 : (s.currentDarts + 1);
		var new_team = change_team ? $author$project$Tactics$otherTeam(s.currentTeam) : s.currentTeam;
		var new_teamAPoints = _Utils_eq(new_team, $author$project$Tactics$A) ? (s.teamAPoints - points) : s.teamAPoints;
		var new_teamBPoints = _Utils_eq(new_team, $author$project$Tactics$B) ? (s.teamBPoints - points) : s.teamBPoints;
		var scoreUpdate = function (entry) {
			if (entry.$ === 'Just') {
				var _v2 = entry.a;
				var ca = _v2.a;
				var cb = _v2.b;
				return _Utils_eq(new_team, $author$project$Tactics$A) ? $elm$core$Maybe$Just(
					_Utils_Tuple2(ca + count, cb)) : $elm$core$Maybe$Just(
					_Utils_Tuple2(ca, cb + count));
			} else {
				return _Utils_eq(new_team, $author$project$Tactics$A) ? $elm$core$Maybe$Just(
					_Utils_Tuple2(count, 0)) : $elm$core$Maybe$Just(
					_Utils_Tuple2(0, count));
			}
		};
		var new_scoreBoard = (!count) ? s.scoreBoard : A3($elm$core$Dict$update, category, scoreUpdate, s.scoreBoard);
		var new_teamACurrent = (change_team && _Utils_eq(new_team, $author$project$Tactics$A)) ? A2(
			$elm$core$Basics$modBy,
			$elm$core$Array$length(s.teamANames),
			s.teamACurrent - 1) : s.teamACurrent;
		var new_teamBCurrent = (change_team && _Utils_eq(new_team, $author$project$Tactics$B)) ? A2(
			$elm$core$Basics$modBy,
			$elm$core$Array$length(s.teamBNames),
			s.teamBCurrent - 1) : s.teamBCurrent;
		return _Utils_update(
			s,
			{choice: $elm$core$Maybe$Nothing, currentDarts: new_darts, currentTeam: new_team, history: hist_remainder, scoreBoard: new_scoreBoard, teamACurrent: new_teamACurrent, teamAPoints: new_teamAPoints, teamBCurrent: new_teamBCurrent, teamBPoints: new_teamBPoints});
	}
};
var $author$project$Tactics$update = F2(
	function (msg, state) {
		switch (msg.$) {
			case 'UndoMsg':
				return $author$project$Tactics$undoUpdate(state);
			case 'ChoiceMsg':
				var scoreEntry = msg.a;
				return A2($author$project$Tactics$scoreEntryUpdate, scoreEntry, state);
			case 'DartboardMsg':
				var dart = msg.a;
				return A2($author$project$Tactics$dartThrowUpdate, dart, state);
			default:
				return state;
		}
	});
	...
	function (m, s) {
		...
		while (true) {
			switch (_v0.b.$) {
				...
				case 'HalbierenState':
					if (_v0.a.$ === 'HalbierenMsg') {
						var hm = _v0.a.a;
						var hs = _v0.b.a;
						return $author$project$Halbieren$isExitMsg(hm) ? _Utils_Tuple2($author$project$Main$initState, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
							$author$project$Main$HalbierenState(
								A2($author$project$Halbieren$update, hm, hs)),
							$elm$core$Platform$Cmd$none);
					} else {
						break _v0$5;
					}
...
var $author$project$Main$HalbierenMsg = function (a) {
	return {$: 'HalbierenMsg', a: a};
};
...
var $author$project$Main$makeOption = F2(
	function (sel, name) {
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$SelectChange(name)),
...
var $author$project$Dartboard$label = function (_v0) {
	var pos = _v0.a;
	var num = _v0.b;
	var h = 14;
	var _v1 = $elm$core$Basics$fromPolar(
		_Utils_Tuple2(
			115,
			$elm$core$Basics$degrees((18.0 * pos) - 90)));
	var xx = _v1.a;
	var yy = _v1.b;
	var cx = (num < 10) ? (xx - 4) : (xx - 8);
	var cy = yy + (h / 2.5);
	return A2(
...
var $rtfeldman$elm_css$Css$pointerEventsFill = A2($rtfeldman$elm_css$Css$property, 'pointer-events', 'fill');
...
var $author$project$Dartboard$D = function (a) {
	return {$: 'D', a: a};
};
var $author$project$Dartboard$G = function (a) {
	return {$: 'G', a: a};
};
var $author$project$Dartboard$K = function (a) {
	return {$: 'K', a: a};
};
var $author$project$Dartboard$T = function (a) {
	return {$: 'T', a: a};
};
...
var $author$project$Util$modByF = F2(
	function (x, mod) {
...
var $author$project$Dartboard$circleArc = F8(
	function (cx, cy, ri, ro, a0, a1, hover_zoom, attr) {
		var y3 = $elm$core$String$fromFloat(
			cy - (ri * $elm$core$Basics$cos(
				$elm$core$Basics$degrees(a0))));
		var y2 = $elm$core$String$fromFloat(
			cy - (ri * $elm$core$Basics$cos(
				$elm$core$Basics$degrees(a1))));
		var y1 = $elm$core$String$fromFloat(
			cy - (ro * $elm$core$Basics$cos(
				$elm$core$Basics$degrees(a1))));
		var y0 = $elm$core$String$fromFloat(
			cy - (ro * $elm$core$Basics$cos(
				$elm$core$Basics$degrees(a0))));
		var x3 = $elm$core$String$fromFloat(
			cx + (ri * $elm$core$Basics$sin(
				$elm$core$Basics$degrees(a0))));
		var x2 = $elm$core$String$fromFloat(
			cx + (ri * $elm$core$Basics$sin(
				$elm$core$Basics$degrees(a1))));
		var x1 = $elm$core$String$fromFloat(
			cx + (ro * $elm$core$Basics$sin(
				$elm$core$Basics$degrees(a1))));
		var x0 = $elm$core$String$fromFloat(
			cx + (ro * $elm$core$Basics$sin(
				$elm$core$Basics$degrees(a0))));
		var rm = (ri + ro) / 2;
		var largeArc = (A2($author$project$Util$modByF, a1 - a0, 360) > 180) ? '1' : '0';
		var am = a0 + (A2($author$project$Util$modByF, a1 - a0, 360) / 2);
		var ox = cx + (rm * $elm$core$Basics$sin(
			$elm$core$Basics$degrees(am)));
		var oy = cy - (rm * $elm$core$Basics$cos(
			$elm$core$Basics$degrees(am)));
		var hover_css = $rtfeldman$elm_css$Svg$Styled$Attributes$css(
			hover_zoom ? _List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									$rtfeldman$elm_css$Css$px(-((0.1 * ox) / 1.1)),
									$rtfeldman$elm_css$Css$px(-((0.1 * oy) / 1.1)))
								]))
						]))
				]) : _List_Nil);
		return A2(
...
var $author$project$Dartboard$segment = F6(
	function (cx, cy, r, top, _v0, attr) {
		var pos = _v0.a;
		var num = _v0.b;
		var stroke_width = $elm$core$String$fromFloat(0.01 * r);
		var special = $author$project$Util$even(pos) ? 'red' : 'green';
		var r5 = 1.0 * r;
		var r4 = 0.9 * r;
		var r3 = 0.6 * r;
		var r2 = 0.5 * r;
		var r1 = 0.15 * r;
		var normal = $author$project$Util$even(pos) ? 'black' : '#ffeecc';
		var layer_css = $rtfeldman$elm_css$Svg$Styled$Attributes$css(
			top ? _List_fromArray(
				[
		...
		return A2(
			...
			_List_fromArray(
				[
					A8(
					$author$project$Dartboard$circleArc,
					cx,
					cy,
					r1,
					r2,
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Svg$Styled$Attributes$fill(normal),
							$rtfeldman$elm_css$Svg$Styled$Attributes$stroke('grey'),
							$rtfeldman$elm_css$Svg$Styled$Attributes$strokeWidth(stroke_width),
							$rtfeldman$elm_css$Svg$Styled$Events$onClick(
							$author$project$Dartboard$K(num)),
							layer_css
						])),
					A8(
					$author$project$Dartboard$circleArc,
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Svg$Styled$Attributes$fill(special),
							$rtfeldman$elm_css$Svg$Styled$Attributes$stroke('grey'),
							$rtfeldman$elm_css$Svg$Styled$Attributes$strokeWidth(stroke_width),
							$rtfeldman$elm_css$Svg$Styled$Events$onClick(
							$author$project$Dartboard$T(num)),
							layer_css
						])),
					A8(
					$author$project$Dartboard$circleArc,
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Svg$Styled$Attributes$strokeWidth(stroke_width),
							$rtfeldman$elm_css$Svg$Styled$Events$onClick(
							$author$project$Dartboard$G(num)),
							layer_css
						])),
					A8(
					$author$project$Dartboard$circleArc,
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Svg$Styled$Attributes$strokeWidth(stroke_width),
							$rtfeldman$elm_css$Svg$Styled$Events$onClick(
							$author$project$Dartboard$D(num)),
							layer_css
						]))
				]));
	});
var $author$project$Dartboard$segments = A2(
	$author$project$Util$zip,
...
var $author$project$Dartboard$dartboard = F2(
	function (size, attr) {
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$core$String$fromInt(size)),
							$rtfeldman$elm_css$Svg$Styled$Attributes$viewBox('-150 -150 300 300'),
							$rtfeldman$elm_css$Svg$Styled$Attributes$css(
							_List_fromArray(
								[$rtfeldman$elm_css$Css$pointerEventsFill]))
						]),
					A2(
						$elm$core$List$cons,
						A2(
...
var $author$project$Halbieren$DartboardMsg = function (a) {
	return {$: 'DartboardMsg', a: a};
};
...
var $author$project$Halbieren$getScoreboardWithVictory = function (s) {
	var players = A2(
		$elm$core$List$range,
		0,
		$elm$core$Array$length(s.playerNames) - 1);
	...
	var maxScore = A2(
		$elm$core$Maybe$withDefault,
		0,
		$elm$core$List$maximum(lastPoints));
	var winningPlayers = A2(
		$elm$core$List$filterMap,
		function (_v0) {
			var pl = _v0.a;
			var fs = _v0.b;
			return _Utils_eq(fs, maxScore) ? $elm$core$Maybe$Just(pl) : $elm$core$Maybe$Nothing;
		},
		A3(
			$elm$core$List$map2,
			F2(
	...
	var finished = A2(
		...
		points);
	return (!finished) ? s.playerPoints : A3(
		$elm$core$List$foldl,
		F2(
			function (p, sb) {
				return A3($author$project$Halbieren$addPlayerPoints, p, sb, -1);
			}),
		s.playerPoints,
		winningPlayers);
};
var $rtfeldman$elm_css$Css$padding2 = $rtfeldman$elm_css$Css$prop2('padding');
var $author$project$Halbieren$roundName = function (r) {
	switch (r.$) {
		case 'Number':
			var i = r.a;
	...
	function (length, _default, matrix) {
		return (!length) ? _List_Nil : A2(
			...
			A2(
				...
				matrix),
			A3(
				$author$project$Halbieren$transposeWithDefault,
				length - 1,
				_default,
				A2(
					$elm$core$List$map,
...
var $author$project$Halbieren$preparePointsTableRows = function (s) {
	...
	var players = A2(
		...
		0,
		$elm$core$Array$length(s.playerNames) - 1);
	var playerPointsWithVictory = $author$project$Halbieren$getScoreboardWithVictory(s);
	var pointsLists = _Utils_ap(
		_List_fromArray(
			[
				A2(
				$elm$core$List$cons,
		...
		A2(
			...
			players));
	var rowStrings = A3($author$project$Halbieren$transposeWithDefault, rows, '', pointsLists);
	var makeTD = function (string) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$td,
			(string === '☆') ? _List_fromArray(
		...
		body: A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Halbieren')
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_Nil,
						...
						[
							...
							_List_fromArray(
								[
									A2(
									$rtfeldman$elm_css$Html$Styled$map,
									$author$project$Halbieren$DartboardMsg,
									A2($author$project$Dartboard$dartboard, 600, _List_Nil))
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
								...
								_Utils_ap(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Halbieren$UndoMsg),
													$rtfeldman$elm_css$Html$Styled$Attributes$css(
													_List_fromArray(
														[
															$rtfeldman$elm_css$Css$marginTop(
											...
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Halbieren$ExitMsg),
													$rtfeldman$elm_css$Html$Styled$Attributes$css(
													_List_fromArray(
														[
															$rtfeldman$elm_css$Css$marginTop(
							...
							_List_fromArray(
								[
									...
									_Utils_ap(
										...
										$author$project$Halbieren$preparePointsTableRows(s)))
								]))
						]))
				])),
		title: 'Halbieren'
...
var $author$project$Tactics$tableRow = F2(
	function (s, _v0) {
		var n = _v0.a;
		var label = _v0.b;
		var finished_css = A2($elm$core$Dict$member, n, s.scoreBoard) ? _List_Nil : _List_fromArray(
			[
		...
		var _v1 = A2(
			$elm$core$Maybe$withDefault,
			_Utils_Tuple2(0, 0),
			A2($elm$core$Dict$get, n, s.scoreBoard));
		var ca = _v1.a;
		var cb = _v1.b;
		return A2(
			$rtfeldman$elm_css$Html$Styled$tr,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(finished_css)
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Tactics$tableRows = _Utils_ap(
	A2(
		$elm$core$List$map,
		function (n) {
			return _Utils_Tuple2(
...
var $author$project$Tactics$view = function (s) {
	var teamBCurrent = A2(
		$elm$core$Maybe$withDefault,
		'',
		A2($elm$core$Array$get, s.teamBCurrent, s.teamBNames));
	var teamB = A2(
		$elm$core$String$join,
		', ',
		$elm$core$Array$toList(s.teamBNames));
	var teamACurrent = A2(
		$elm$core$Maybe$withDefault,
		'',
		A2($elm$core$Array$get, s.teamACurrent, s.teamANames));
	var teamA = A2(
		$elm$core$String$join,
		', ',
		$elm$core$Array$toList(s.teamANames));
	var nextUp = _Utils_eq(s.currentTeam, $author$project$Tactics$A) ? teamBCurrent : teamACurrent;
	var currentPlayer = _Utils_eq(s.currentTeam, $author$project$Tactics$A) ? teamACurrent : teamBCurrent;
	var choiceVisible = function () {
		var _v10 = s.choice;
		if (_v10.$ === 'Nothing') {
			return _List_fromArray(
				[
	...
	var choice2Click = function () {
		var _v9 = s.choice;
		if (_v9.$ === 'Nothing') {
			return _List_Nil;
		} else {
			var value = _v9.a.value;
			var variant = _v9.a.variant;
			return _List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Events$onClick(
					$author$project$Tactics$ChoiceMsg(
						{useSpecial: true, value: value, variant: variant}))
				]);
		}
	}();
	var choice1Click = function () {
		var _v8 = s.choice;
		if (_v8.$ === 'Nothing') {
			return _List_Nil;
		} else {
			var value = _v8.a.value;
			var variant = _v8.a.variant;
			return _List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Events$onClick(
					$author$project$Tactics$ChoiceMsg(
						{useSpecial: false, value: value, variant: variant}))
				]);
		}
	}();
	var _v0 = function () {
		var _v1 = $author$project$Tactics$victory(s);
		if (_v1.$ === 'Victory') {
			if (_v1.a.$ === 'A') {
				var _v2 = _v1.a;
				return _Utils_Tuple2('☆', '');
	...
	var _v4 = function () {
		var _v5 = s.choice;
		if (_v5.$ === 'Nothing') {
			return _Utils_Tuple2('Invalid', 'Invalid');
		} else {
			var value = _v5.a.value;
			var variant = _v5.a.variant;
			var fieldString = (value === 25) ? 'Bull' : $elm$core$String$fromInt(value);
			var _v6 = A2(
				$elm$core$Maybe$withDefault,
				_Utils_Tuple2(0, 0),
				A2($elm$core$Dict$get, variant + 20, s.scoreBoard));
			var ca_var = _v6.a;
			var cb_var = _v6.b;
			var c_var = _Utils_eq(s.currentTeam, $author$project$Tactics$A) ? ca_var : cb_var;
			var c_var_other = _Utils_eq(s.currentTeam, $author$project$Tactics$A) ? cb_var : ca_var;
			var points2S = ((!c_var) && (c_var_other > 0)) ? (' (' + ($elm$core$String$fromInt(variant * value) + ' points)')) : '';
			var _v7 = A2(
				$elm$core$Maybe$withDefault,
				_Utils_Tuple2(0, 0),
				A2($elm$core$Dict$get, value, s.scoreBoard));
			var ca_val = _v7.a;
			var cb_val = _v7.b;
			var c_val = _Utils_eq(s.currentTeam, $author$project$Tactics$A) ? ca_val : cb_val;
			var c_val_other = _Utils_eq(s.currentTeam, $author$project$Tactics$A) ? cb_val : ca_val;
			var points1S = ((_Utils_cmp(c_val, variant) < 0) && (c_val_other > 0)) ? (' (' + ($elm$core$String$fromInt((variant - c_val) * value) + ' points)')) : '';
			return _Utils_Tuple2(
				$elm$core$String$fromInt(variant) + (' x ' + (fieldString + points1S)),
				_Utils_ap(
					(variant === 2) ? 'Double' : 'Triple',
					points2S));
		}
	}();
	var choice1Text = _v4.a;
	var choice2Text = _v4.b;
	return {
		body: A2(
			$elm$core$List$map,
			$rtfeldman$elm_css$Html$Styled$toUnstyled,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Tactics Scoreboard')
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_Nil,
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$rtfeldman$elm_css$Html$Styled$text(choice1Text)
														])),
													A2($rtfeldman$elm_css$Html$Styled$br, _List_Nil, _List_Nil),
													A2(
													$rtfeldman$elm_css$Html$Styled$span,
													...
													_List_fromArray(
														[
															$rtfeldman$elm_css$Html$Styled$text(choice2Text)
														]))
												]))
										]))
								])),
								...
								_Utils_ap(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Tactics$UndoMsg),
													$rtfeldman$elm_css$Html$Styled$Attributes$css(
													_List_fromArray(
														[
															$rtfeldman$elm_css$Css$marginTop(
											...
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Tactics$ExitMsg),
													$rtfeldman$elm_css$Html$Styled$Attributes$css(
													_List_fromArray(
														[
															$rtfeldman$elm_css$Css$marginTop(
									...
									_Utils_ap(
										_List_fromArray(
											[
												...
												$author$project$Tactics$tableSeparator
											]),
										A3(
											$author$project$Util$intersperseEvery,
											3,
											$author$project$Tactics$tableSeparator,
											_Utils_ap(
												A2(
													$elm$core$List$map,
													$author$project$Tactics$tableRow(s),
													$author$project$Tactics$tableRows),
												_List_fromArray(
													[
														A2(
														$rtfeldman$elm_css$Html$Styled$tr,
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$rtfeldman$elm_css$Html$Styled$text(
																		$elm$core$String$fromInt(s.teamAPoints))
																	])),
																A2(
																$rtfeldman$elm_css$Html$Styled$td,
																_List_Nil,
																...
																_List_fromArray(
																	[
																		$rtfeldman$elm_css$Html$Styled$text(
																		$elm$core$String$fromInt(s.teamBPoints))
																	]))
															])),
														A2(
														$rtfeldman$elm_css$Html$Styled$tr,
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$rtfeldman$elm_css$Html$Styled$text(victory_a)
																	])),
																...
																_List_fromArray(
																	[
																		$rtfeldman$elm_css$Html$Styled$text(victory_b)
																	]))
															]))
													])))))
								]))
...
var $author$project$Main$view = function (s) {
	switch (s.$) {
		...
		case 'HalbierenState':
			...
			return A2(
				$author$project$Main$mapDocument,
				$author$project$Main$HalbierenMsg,
				$author$project$Halbieren$view(hs));
		default:
			var sel = s.a;
			var players = s.b;
			return {
